...
#[cfg(feature = "kanden_ident")]
impl<I, S> From<kanden_ident::Ident<I>> for Value<S>
where
    I: Into<Value<S>>,
{
    fn from(value: kanden_ident::Ident<I>) -> Self {
...
#[cfg(feature = "kanden_ident")]
impl<'a> From<&'a kanden_ident::Ident<String>> for ValueRef<'a, String> {
    fn from(v: &'a kanden_ident::Ident<String>) -> Self {
