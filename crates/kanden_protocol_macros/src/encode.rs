...
pub(super) fn derive_encode(item: TokenStream) -> Result<TokenStream> {
    ...
    add_trait_bounds(
        &mut input.generics,
        quote!(::kanden_protocol::__private::Encode),
    );
    ...
    match input.data {
        Data::Struct(struct_) => {
            ...
            Ok(quote! {
                ...
                impl #impl_generics ::kanden_protocol::__private::Encode for #input_name #ty_generics
                #where_clause
                {
                    fn encode(&self, mut _w: impl ::std::io::Write) -> ::kanden_protocol::__private::Result<()> {
                        use ::kanden_protocol::__private::{Encode, Context};
        ...
        Data::Enum(enum_) => {
            ...
            Ok(quote! {
                ...
                {
                    fn encode(&self, mut _w: impl ::std::io::Write) -> ::kanden_protocol::__private::Result<()> {
                        use ::kanden_protocol::__private::{Encode, VarInt, Context};
