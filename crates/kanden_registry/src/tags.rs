...
pub use kanden_protocol::packets::play::update_tags_s2c::RegistryMap;
use kanden_protocol::packets::play::UpdateTagsS2c;
...
impl TagsRegistry {
    pub fn default_tags() -> kanden_protocol::packets::configuration::UpdateTagsS2c<'static> {
        let registries =
            serde_json::from_str::<RegistryMap>(include_str!("../extracted/tags.json"))
                .expect("tags.json must have expected structure");

        kanden_protocol::packets::configuration::UpdateTagsS2c {
