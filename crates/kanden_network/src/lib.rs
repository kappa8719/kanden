...
use tracing::error;
use uuid::Uuid;
use kanden_protocol::text::IntoText;
use kanden_protocol::VarInt;
use kanden_server::client::{ClientBundle, ClientBundleArgs, Properties, SpawnClientsSet};
use kanden_server::registry::biome::{Biome, BiomeId};
use kanden_server::registry::dimension_type::{DimensionType, DimensionTypeId};
use kanden_server::registry::{BiomeRegistry, DimensionTypeRegistry, Registry, TagsRegistry};
use kanden_server::{
...
pub trait NetworkCallbacks: Send + Sync + 'static {
    ...
    async fn server_list_ping(
        ...
        ServerListPing::Respond {
            ...
            player_sample: vec![],
            description: "A Kanden Server".into_text(),
            favicon_png: &[],
...
pub enum ConnectionMode {
    ...
    Velocity {
        ...
        /// The proxy and Kanden must be configured to use the same secret key.
        secret: Arc<str>,
    },
}
...
pub enum ServerListPing<'a> {
    ...
    Respond {
        ...
        /// [`kanden_protocol::text::Text::to_legacy_lossy`].
        version_name: String,
