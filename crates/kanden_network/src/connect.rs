...
use kanden_protocol::packets::login::{LoginAcknowledgedC2s, LoginFinishedS2c};
use kanden_protocol::packets::status::{
    PingRequestC2s, PongResponseS2c, StatusRequestC2s, StatusResponseS2c,
};
use kanden_protocol::profile::Property;
use kanden_protocol::{Bounded, Decode, JsonText};
use kanden_server::client::Properties;
use kanden_server::nbt::serde::ser::CompoundSerializer;
use kanden_server::protocol::packets::handshake::intention_c2s::HandShakeIntent;
use kanden_server::protocol::packets::handshake::IntentionC2s;
use kanden_server::protocol::packets::login::{
    CustomQueryAnswerC2s, CustomQueryS2c, HelloC2s, HelloS2c, KeyC2s, LoginCompressionS2c,
    LoginDisconnectS2c,
};
use kanden_server::protocol::{PacketDecoder, PacketEncoder, RawBytes, VarInt};
...
async fn handle_login(
    ...
    // We have kanden support for the `worldgen/biome` and `dimension_type`
