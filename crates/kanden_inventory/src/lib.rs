...
use kanden_server::protocol::packets::play::open_screen_s2c::WindowType;
pub use kanden_server::protocol::packets::play::player_action_c2s::PlayerAction;
...
impl Inventory {
    ...
    ///
    /// ```
    /// # use kanden_inventory::*;
    /// # use kanden_server::item::{ItemStack, ItemKind};
