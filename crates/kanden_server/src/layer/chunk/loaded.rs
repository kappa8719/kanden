...
use kanden_generated::block::{PropName, PropValue};
use kanden_nbt::Compound;
use kanden_protocol::encode::{PacketWriter, WritePacket};
use kanden_protocol::packets::play::level_chunk_with_light_s2c::{
    ChunkDataBlockEntity, HeightMap, HeightMapKind,
};
use kanden_protocol::packets::play::section_blocks_update_s2c::ChunkDeltaUpdateEntry;
...
use kanden_registry::biome::BiomeId;
use kanden_registry::RegistryIdx;
...
impl LoadedChunk {
    ...
    /// ingame.
    ///
    /// [`DimensionType::min_y`]: kanden_registry::dimension_type::DimensionType::min_y
...
mod tests {
    use kanden_nbt::compound;
    use kanden_protocol::CompressionThreshold;
