...
use kanden_server::protocol::packets::play::commands_s2c::{Node, NodeData, Parser, StringArg};
use kanden_server::protocol::packets::play::CommandsS2c;
...
/// use kanden_command::graph::{
///     CommandGraph, CommandGraphBuilder
/// };
/// use kanden_command::{CommandRegistry};
/// use kanden_command::parsers::CommandArg;
///
/// struct TestCommand {
///    test: i32,
/// }
...
impl<'a, T> CommandGraphBuilder<'a, T> {
    ...
    /// use std::collections::HashMap;
    ///
    /// use kanden_command::graph::CommandGraphBuilder;
    /// use kanden_command::CommandRegistry;
    ///
    /// struct TestCommand;
    ///
