    ...
    match input.data {
        Data::Enum(data_enum) => {
            ...
            Ok(TokenStream::from(quote! {
                ...
                impl kanden::command::Command for #input_name {
                    fn assemble_graph(command_graph: &mut kanden::command::graph::CommandGraphBuilder<Self>) {
                        use kanden::command::parsers::CommandArg;
